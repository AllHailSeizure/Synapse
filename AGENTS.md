...
Use `goals` to orient work around GitHub milestones and issues. Its Codex agents are registered under `.codex/agents/synapse/`:
...
The skill source is in `skills/goals/SKILL.md`.
